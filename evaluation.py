...
class InventoryEvaluator:
    ...
    def generate_detailed_report(self, results: Dict[str, Any]) -> str:
        ...
        report.append("ENVIRONMENT DESCRIPTION (Teacher's Parameters):")
        report.append("- Mission: Minimize overall cost")
        ...
        report.append("- Product 2: Demand D = {2,3,4,5} with probabilities {1/8, 1/2, 1/4, 1/8}")
